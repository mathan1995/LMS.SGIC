...
public class ViewMainClassificationController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<MainClassifaction> result;
            MainClassifactionDataAccessObject mainClassification = new MainClassifactionDataAccessObject();
            result = mainClassification.showMainclassification();
            int records = result.size();
            request.setAttribute("result", result);
            request.setAttribute("records", records);
            RequestDispatcher dispatcher = request.getRequestDispatcher("/MainClassi.jsp");
